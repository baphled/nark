...
eventually end up.
  ...
  define_plugin :request_times do
    class_variables => { :last_request_time => nil, :request_times => [] }

    before_call -> { |env| @start_time = Time.now }
  ...
  define_plugin :requests do
    class_variables: { :total_requests => 0 }

    before_call -> { |env| self.class.increment_requests }
  end
